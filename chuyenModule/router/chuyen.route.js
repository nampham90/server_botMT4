...
module.exports = app => {
    ...
    route.post('/chuyenAnt100updateTrangthai', verifyToken, Chuyen.updateStatus);
    route.post('/chuyenAnt100Hoanthanhchuyenhang', verifyToken, Chuyen.hoanthanhchuyenhang);
