module.exports = app => {
    ...
    route.post('/chuyenngoaiAnt100ExportDetail', verifyToken, Chuyenngoai.PostExportDetail);
    ...
    route.post('/chuyenngoaiAnt100UpdateStatus02',verifyToken,Chuyenngoai.PostUpdateStatus02);
