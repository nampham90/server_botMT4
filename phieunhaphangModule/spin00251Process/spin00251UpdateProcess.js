...
const CommonCheckSoIDProcess = require("../../process/commonProcess/commonCheckSoIDProcess");
        ...
        for(let element of listsp) {
            ...
            await PNH.collection.updateOne(
                ...
                {$set: {
                    ...
                    makho: element.makho,
                    hinhthucthanhtoan: parseInt(data['spin00251Header']['hinhthucthanhtoan']),
