...
exports.getDetailsoID = async (req,res) => {
    try {
        ...
        await phieunhaphangGetDetailIDProcess.start();
        const session = phieunhaphangGetDetailIDProcess.transaction;
        let response = await phieunhaphangGetDetailIDProcess.getDetailID(req.body,session);
        await phieunhaphangGetDetailIDProcess.commit();
